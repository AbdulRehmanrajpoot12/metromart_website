...
export async function createCheckoutSession(items: CartItem[], metadata: Metadata) {
    try {
        ...
        const sessionPayload: Stripe.Checkout.SessionCreateParams = {
            ...
            success_url: `https://metromart-website.vercel.app/success?.session_id={CHECKOUT_SESSION_ID}&orderNumber=${metadata.orderNumber}`,
            cancel_url:`https://metromart-website.vercel.app/cart`,
